...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::table('alevel_schools', function (Blueprint $table) {
        ...
        DB::statement("
            ...
            WHERE als.region_code = ps.region_code
            AND als.district_code = ps.district_code
        ");
